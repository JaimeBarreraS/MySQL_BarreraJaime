 create database Jaime_tarea_dia3; -- crear base de datos
 
 use Jaime_tarea_dia3; -- utilizar base de datos
 ...
 codigo_jefe int(11),
 puesto varchar(50),
 -- foreign key (codigo_jefe) references empleado(codigo_jefe),
...
-- INSERCION DE DATOS GAMA_PRODUCTO
...
-- INSERCION DE DATOS DETALLE_PEDIDO
